...
export default function Sidebar() {
    ...
    const items = isAdminSection ? ADMIN_NAV_ITEMS : NAV_ITEMS;

    return (
        <aside
            className="hidden md:flex flex-col w-56 shrink-0 sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto styled-scroll"
            style={{
                background: "rgba(247,243,238,0.6)",
                borderRight: "1px solid rgba(200,192,185,0.3)",
            }}
        >
            {isAdminSection && (
            ...
            <div
                ...
                style={{ borderColor: "rgba(200,192,185,0.3)" }}
            >
                {isAdminSection ? (
                    <Link
                        href="/"
                        className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-opacity hover:opacity-70"
                        style={{ color: "var(--muted)" }}
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
