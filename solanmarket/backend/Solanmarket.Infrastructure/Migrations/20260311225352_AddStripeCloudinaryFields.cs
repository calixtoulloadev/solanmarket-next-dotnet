...
{
    /// <inheritdoc />
    public partial class AddStripeCloudinaryFields : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EarningMultiplier = table.Column<decimal>(type: "numeric", nullable: false),
                    BadgeEmoji = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplier_categories", x => new { x.SupplierId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_supplier_categories_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_supplier_categories_categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_loyalty_redemptions_LoyaltyRewards_RewardId",
                        column: x => x.RewardId,
                        principalTable: "LoyaltyRewards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_loyalty_redemptions_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IconType = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedPayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SavedPayments_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_tags", x => new { x.ProductId, x.Tag });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_stock_transfers_product_variants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "product_variants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_stock_transfers_users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_warehouse_stocks_product_variants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "product_variants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CNNumber = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    Type = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    SupplierId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_credit_notes_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_credit_notes_orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_loyalty_transactions_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantDetails = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_credit_notes_CNNumber",
                table: "credit_notes",
                column: "CNNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_credit_notes_OrderId",
                table: "credit_notes",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_credit_notes_SupplierId",
                table: "credit_notes",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_loyalty_redemptions_RewardId",
                table: "loyalty_redemptions",
                column: "RewardId");

            migrationBuilder.CreateIndex(
                name: "IX_loyalty_redemptions_UserId",
                table: "loyalty_redemptions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_loyalty_transactions_UserId",
                table: "loyalty_transactions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_stock_transfers_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_stock_transfers_ProductVariantId",
                table: "stock_transfers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplier_categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_warehouse_stocks_ProductVariantId",
                table: "warehouse_stocks",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_warehouse_stocks_WarehouseId_ProductVariantId",
                table: "warehouse_stocks",
